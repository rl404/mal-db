...
// GetReviews to get manga review list.
...
func (r *review) getSourceID() int {
	...
	return utils.StrToNum(utils.GetValueFromSplit(link, "/", 2))
}
...
func (r *review) getSourceTitle() string {
	titleArea := r.area.Parent().Find("h1.h1 span").First()
